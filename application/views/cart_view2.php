...
<div id="carousel-example-generic" class="carousel slide" data-ride="carousel" style="height:300px">
  ...
  <div class="carousel-inner" role="listbox">
    <div class="item active" align="center">
      <img style="max-height:300px; width:100%;" src="./images/Chrysanthemum.jpg" alt="...">
      <div class="carousel-caption">
        
      </div>
    </div>
    <div class="item" align="center">
      <img style="max-height:300px; width:100%;" src="./images/Jellyfish.jpg" alt="...">
      <div class="carousel-caption">
       
      </div>
    </div>
	<div class="item" align="center">
      <img style="max-height:300px; width:100%;" src="./images/Koala.jpg" alt="...">
      <div class="carousel-caption">
            ...
            foreach ($products as $product) {
                ...
                <div class="col-md-4" style="padding-left:0px;" >  
                    <table class="table table-borderd">
                        <td><img id="<?php echo $id;?>" class="media-object p_desc" height="150" width="160" src="<?php echo base_url() . $product['image'] ?>"/></td>
